              ...
              predict.all=FALSE, proximity = FALSE, nodes=FALSE, cutoff, ...)
{
    ...
    if (inherits(object, "viRandomForests.formula")) {
    ...
    if (object$type == "regression") {
            ...
            ans <- .C("regForest",
                  ...
                  DUP=FALSE,
                  PACKAGE = "viRandomForests")[keepIndex]
